# slabcraft:verticle/set_marker/back/east

summon minecraft:armor_stand ~ ~ ~ {Tags:["sc_slab","sc_verticle_slab","sc_back_verticle_slab","sc_east_verticle_slab","sc_new_summoned"],ArmorItems:[{},{},{},{Count:1b,id:"minecraft:diamond_sword",tag:{Damage:1s,Unbreakable:1b}}],NoGravity:1b,Invisible:1b,Invulnerable:1b,Small:1b,Marker:1b,Silent:1b,Fire:32767s,Rotation:[270f,0f]}
