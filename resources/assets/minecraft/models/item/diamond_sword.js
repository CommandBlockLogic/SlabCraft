...
for (let i = 0; i < arr.length; i++) {
    ...
    result += `{
        ...
        "model": "slabcraft:horizon_slab/bottom/${element}"
    },`
}
for (let i = 0; i < arr.length; i++) {
    const element = arr[i];
    result += `{
        ...
        "model": "slabcraft:horizon_slab/top/${element}"
    },`
}
for (let i = 0; i < arr.length; i++) {
    const element = arr[i];
    result += `{
        ...
        "model": "slabcraft:verticle_slab/front/${element}"
    },`
}
for (let i = 0; i < arr.length; i++) {
    const element = arr[i];
    result += `{
        ...
        "model": "slabcraft:verticle_slab/back/${element}"
    },`
}
